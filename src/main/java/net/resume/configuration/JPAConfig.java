...
@EnableJpaRepositories("net.resume.repository.storage")
public class JPAConfig {
	...
	//настройки фабрики для создания менеджеров для работы с entity
	@Bean
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
		...
		entityManagerFactory.setPackagesToScan("net.resume.entity");
