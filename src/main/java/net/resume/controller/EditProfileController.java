...
import net.resume.annotation.constraints.FirstFieldLessThanSecond;
import net.resume.component.FormErrorConverter;
import net.resume.entity.Contacts;
import net.resume.entity.Profile;
import net.resume.exception.FormValidationException;
import net.resume.form.CertificateForm;
import net.resume.form.CourseForm;
import net.resume.form.EducationForm;
import net.resume.form.InfoForm;
import net.resume.form.LanguageForm;
import net.resume.form.PasswordForm;
import net.resume.form.PracticForm;
import net.resume.form.SkillForm;
...
import net.resume.util.SecurityUtil;

//контроллер для обработки URL для меню изменения профиля
@Controller
public class EditProfileController {
	...
	//преобразовывает типы обьектов и enum
	@InitBinder
