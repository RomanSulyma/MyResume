...
import net.resume.service.SocialService;
import net.resume.util.SecurityUtil;


//контроллер для обработки логина через фейсбук
@Controller
public class FacebookController {
	...
	//формирует запрос на получение данных
	...
	//получает код авторизация с фейсбука и логинит юзера
	...
	//формирует токен и запрашывает данные о пользователе с фейсбука
