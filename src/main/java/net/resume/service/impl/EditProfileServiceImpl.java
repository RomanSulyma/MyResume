...
import net.resume.annotation.ProfileDataFieldGroup;
import net.resume.annotation.ProfileInfoField;
...
import net.resume.exception.FormValidationException;
...
import net.resume.repository.search.ProfileSearchRepository;
...
import net.resume.entity.ProfileEntity;
import net.resume.entity.Skill;
import net.resume.entity.SkillCategory;
import net.resume.repository.storage.AbstractProfileEntityRepository;
import net.resume.repository.storage.CertificateRepository;
import net.resume.repository.storage.CourseRepository;
import net.resume.repository.storage.EducationRepository;
import net.resume.repository.storage.HobbyRepository;
import net.resume.repository.storage.LanguageRepository;
import net.resume.repository.storage.PracticRepository;
import net.resume.repository.storage.SkillCategoryRepository;
import net.resume.repository.storage.SkillRepository;
import net.resume.service.CacheService;
import net.resume.service.EditProfileService;
import net.resume.service.ImageProcessorService;
import net.resume.service.ImageStorageService;
import net.resume.service.NotificationManagerService;
import net.resume.service.StaticDataService;

//Сервис для управления изменениями данных пользователя
@Service
...
public class EditProfileServiceImpl extends AbstractCreateProfileService implements EditProfileService {
	...
	//получает список картинок для удаления
	...
	//обновляет данные профиля включая картинку из профиля для пересохранения в БД
	@Override
	@Transactional
	...
	//непосредственно сохраняет изменения в БД
	...
	//Получаем список хобби и на основе выборки создаем новый обьект
	@Override
	...
	//выполняет обновление хобби в БД
	@Override
	@Transactional
	...
	//Строит карту для сохранения порядка отображения скиллов
	...
	//Очищает список ссылок на картинки
	...
	//обновляет все коллекции которые есть в профиле получая нужный тип коллекции
	...
	//удаляет данные из кеша для перезагрузки кеша
	...
	//обновляет индексы всех полей в Entity в ElasticSearch допустим при добвалении новго хобби
