...
//Позволяет логинится или регистрироватся через фейсбук с созданием новго профиля , а так же методами для взятия данных из ФБ
@Service
public class FacebookSocialService extends AbstractCreateProfileService implements SocialService<User> {
	...
	//генерирует пароль отправляет пароль на email
