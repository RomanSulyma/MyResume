...
import net.resume.repository.storage.ProfileRestoreRepository;
import net.resume.service.CacheService;
import net.resume.service.FindProfileService;
...
public class FindProfileServiceImpl implements FindProfileService {
	...
	//инициализуерем коллекции дял индексирования что бы избежать LI Exception
	@Override
	@Transactional
